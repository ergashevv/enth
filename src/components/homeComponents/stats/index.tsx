            ...
            <div>
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-[100px]">
                    {stats.map((stat, index) => (
                        <div
                            key={index}
                            className="bg-[#DCF4FFB2] rounded-[30px] pt-[26px] pr-[43px] pb-[32px] pl-[40px] sm:px-8 sm:py-10 flex flex-col items-center  h-full shadow-sm hover:shadow-md transition-shadow"
                        >
                            <span className="sm:text-[36px] md:text-[44px] lg:text-[50px] font-montserrat font-semibold text-[50px] leading-[120%] tracking-normal text-[#0060AE] text-left">
                                {stat.value}
                            </span>
