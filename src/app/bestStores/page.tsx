...
export default function BestPage() {
  return (
    <main className="min-h-screen bg-white">
      <section className="container mx-auto rounded-3xl bg-[#E6F7FF] py-8 sm:py-12 px-4 md:px-12 mt-8">
      ...
      <div className="container mx-auto flex flex-col lg:flex-row gap-6 px-4 md:px-12 py-10">
